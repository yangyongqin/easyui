...
public class PageDialog extends JDialog{
	...
	PageDialog(){
		...
		pageIdLabel=new JLabel("页签ID");
		pageIdField=new JTextField();
		pageNameLabel=new JLabel("页签名称");
	...
	PageDialog(String pageId,String pageName){
		this();
		pageIdField.setText(pageId);
		pageNameField.setText(pageName);
	}
	CodeValue codeValue;
	public static CodeValue select(JComponent com,String pageId,String pageName){
		PageDialog dialog=new PageDialog(pageId,pageName);
