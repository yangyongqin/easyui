 ...
 *
 */
public class UITabbedPaneUI extends TabbedPaneUI implements SwingConstants{
...
//	 Instance variables initialized at installation
    ...
    public static final int LIST_SCROLL_TAB_LAYOUT = 2;
...
// Private instance data
	...
	// 单个页签的时候是否显示页签
	protected boolean m_singletabVisible = true;

	public UITabbedPaneUI() {
		super();
	}

	/**
	 * NC标准TabpaneUI
	 * @param singletabVisible 单个页签的时候是否显示页签
	 */
	public UITabbedPaneUI(boolean singletabVisible) {
		super();
		m_singletabVisible = singletabVisible;
	}
	...
	protected boolean isTabShowable() {
		return !isSingleTab() || m_singletabVisible;
	}
...
//UI Installation/De-installation
    ...
    * which have extended UITabbedPaneUI to do their own layout, the
   ...
   private static class RightAction extends AbstractAction {
	private static final long serialVersionUID = 3065138280498936640L;

	public void actionPerformed(ActionEvent e) {
           JTabbedPane pane = (JTabbedPane) e.getSource();
           UITabbedPaneUI ui = (UITabbedPaneUI) pane.getUI();
           ui.navigateSelectedTab(EAST);
       }
   }

   private static class LeftAction extends AbstractAction {
	private static final long serialVersionUID = -5072703078625492352L;
   ...
   private static class UpAction extends AbstractAction {
	private static final long serialVersionUID = 1752592719279908539L;
   ...
   private static class DownAction extends AbstractAction {
	private static final long serialVersionUID = 654635366441258309L;
   ...
   private static class NextAction extends AbstractAction {
	private static final long serialVersionUID = -8584652615636716811L;
   ...
   private static class PreviousAction extends AbstractAction {
	private static final long serialVersionUID = 8180017378253051910L;
   ...
   private static class PageUpAction extends AbstractAction {
	private static final long serialVersionUID = -1561016203499095882L;
   ...
   private static class PageDownAction extends AbstractAction {
	private static final long serialVersionUID = -4169465167549877674L;
   ...
   private static class RequestFocusAction extends AbstractAction {
	private static final long serialVersionUID = -7794955650243400344L;
   ...
   private static class RequestFocusForVisibleAction extends AbstractAction {
	private static final long serialVersionUID = -5785312211081450143L;
   ...
   private static class SetSelectedIndexAction extends AbstractAction {
	private static final long serialVersionUID = 2349170898743454383L;

	public void actionPerformed(ActionEvent e) {
           JTabbedPane pane = (JTabbedPane) e.getSource();

           if (pane != null && (pane.getUI() instanceof UITabbedPaneUI)) {
               UITabbedPaneUI ui = (UITabbedPaneUI) pane.getUI();
   ...
   private static class ScrollTabsForwardAction extends AbstractAction {
	private static final long serialVersionUID = -9042500693958943481L;
   ...
   private static class ScrollTabsBackwardAction extends AbstractAction {
	private static final long serialVersionUID = -6010222065791635647L;
...
//UI Rendering
   ...
   public void paint(Graphics g, JComponent c) {
		...
		lightHighlight = new Color(0xA0B3C6);
		shadow = new Color(0xA0B3C6);
		focus = new Color(0xA0B3C6);
       ...
       switch (tabPlacement) {
         ...
         default:
        	 if( !isSelected ){
	             ...
	             g.drawLine(x+w, y, x+w, y+h); // right shadow
...
//	           right highlight
//	             g.setColor(new Color(0xAE743A));
//	             g.drawLine(x+w, y+1, x+w, y+3);
	             g.setColor(lightHighlight);
	             g.drawLine(x+w, y, x+w, y+h);

	             // top highlight
//	             g.setColor(new Color(0xE8AC04));
//	             g.fillRect(x+1,y+1,w-1,2);
//	             g.setColor(new Color(0xAE743A));
//	             g.fillRect(x,y,w,1);
   ...
   private static Color tabBGC1 = new Color(0xDEEFF7);
   private static Color tabBGC2 = new Color(0xCEE3EF);
  protected void paintTabBackground(Graphics g, int tabPlacement,
	   ...
	   if( isSelected ){
		   ...
		   g2d.setPaint(new GradientPaint(x,y,Color.white,x,y+h,tabBGC1));
	   }
	   else{
		   g2d.setPaint(new GradientPaint(x,y,Color.white,x,y+h,tabBGC2));
	   }
		switch(tabPlacement) {
			case LEFT:
				g2d.fillRect(x+1, y+1, w-2, h-3);
				break;
			case RIGHT:
...
//Tab Navigation methods
  ...
  boolean requestFocusForVisibleComponent() {
      ...
      if (visibleComponent.isFocusable()) {
          ...
          if (requestDefaultFocus((JComponent) visibleComponent)) {
              return true;
          }
      }
      return false;
  ...
  private boolean requestDefaultFocus(JComponent com) {
      Container nearestRoot = (com.isFocusCycleRoot()) ? com : com.getFocusCycleRootAncestor();
      if (nearestRoot == null) {
          return false;
      }
    ...
    * Instantiate it only within subclasses of UITabbedPaneUI.
    */
   ...
   private class ScrollableTabViewport extends JViewport implements UIResource {
	private static final long serialVersionUID = 2862416488182114253L;
   ...
   private class ScrollableTabPanel extends JPanel implements UIResource {
	private static final long serialVersionUID = 5684657687045653736L;
	public ScrollableTabPanel() {
       ...
       public void paintComponent(Graphics g) {
           ...
           UITabbedPaneUI.this.paintTabArea(g, tabPane.getTabPlacement(),
   ...
   private class ScrollableTabButton extends BasicArrowButton implements UIResource,SwingConstants {
	private static final long serialVersionUID = 6749362111083815265L;
   ...
   private class Handler implements ChangeListener, ContainerListener,
       ...
       public void propertyChange(PropertyChangeEvent e) {
           ...
           if (name == "mnemonicAt") {
               ...
               UITabbedPaneUI.this.uninstallUI(pane);
               UITabbedPaneUI.this.installUI(pane);
