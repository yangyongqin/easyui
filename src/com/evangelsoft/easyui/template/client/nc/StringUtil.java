...
public class StringUtil
{
  ...
  public static int compareByByte(Object o1, Object o2)
  {
    ...
    byte[] bAry1 = isBytes ? (byte[])(byte[])o1 : o1.toString().getBytes();
    byte[] bAry2 = isBytes ? (byte[])(byte[])o2 : o2.toString().getBytes();
  ...
  public static String toString(Object value, String delim) {
    ...
    if (value.getClass().isArray())
      return toString((Object[])(Object[])value, delim);
